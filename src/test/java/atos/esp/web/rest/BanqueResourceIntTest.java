...
public class BanqueResourceIntTest {
    ...
    private static final String DEFAULT_CODE_B = "AAAAA";
    private static final String UPDATED_CODE_B = "BBBBB";

    private static final String DEFAULT_CODE_P = "AA";
    private static final String UPDATED_CODE_P = "BB";
    ...
    public void getAllBanques() throws Exception {
        ...
        restBanqueMockMvc.perform(get("/api/banques?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].codeB").value(hasItem(DEFAULT_CODE_B.toString())))
            .andExpect(jsonPath("$.[*].codeP").value(hasItem(DEFAULT_CODE_P.toString())));
    }
    ...
    public void getBanque() throws Exception {
        ...
        restBanqueMockMvc.perform(get("/api/banques/{id}", banque.getId()))
            ...
            .andExpect(jsonPath("$.codeB").value(DEFAULT_CODE_B.toString()))
            .andExpect(jsonPath("$.codeP").value(DEFAULT_CODE_P.toString()));
    }
