...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(atos.esp.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(atos.esp.domain.Authority.class.getName(), jcacheConfiguration);
